...
\begin{table}[h!] %	\centering %	\captionsetup{justification=centering}
	\centering
	\caption{Expected Welfare Surplus Difference (WSD), $\text{HNG}_{1040}$ Approach}
	\label{tb:HNG_win05_pop}
	\begin{adjustbox}{}
	\pgfplotstabletypeset[
		col sep=comma,
		every head row/.style={
...
In tables \ref{tb:HNG1_win05_pop}, \ref{tb:HNG1_default_pop}, and \ref{tb:HNG_win05_pop} we see the average of the predictions for the hypothetical population.
