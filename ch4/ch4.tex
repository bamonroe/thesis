...
The degree of confidence in the classification process, and indeed most statistical tests in the economics literature, can be assessed through power analysis.\footnote{
	A \enquote{power analysis} is a process for assessing the probability of type II errors for a given econometric test on data.
	This usually involves simulating independent variables, specifying an effect size, simulating a dependent variable given the independent variables and the effect size, and then testing how frequently the effect size can be recovered from tests on multiple repetitions of the simulated data.
}
