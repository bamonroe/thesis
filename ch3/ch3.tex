...
The usefulness of knowledge of the distributions of preferences in a population will be discussed below.
...
Any observance of MSB, at least under an EUT framework, therefore implies that the agent has made a choice in which she chose an option of lower expected utility than the alternative.

An important and often overlooked reality of stochastic models is that even if a subject doesn't display MSB, the subject may still have made choice errors and therefore may not be realizing their optimal welfare.
