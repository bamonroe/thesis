...
As in equation (\ref{eq2:utilityrank}), we can set the $a$ subscript of the $A-1$ unchosen options in $Z$ equal to their respective rankings in $Z$:
\begin{equation}
...
\addtocounter{footnote}{-1}
\stepcounter{footnote}\footnotetext{
	Lottery $a$ first order stochastically dominates (FOSD) lottery $b$ iff:
	\begin{align*}
